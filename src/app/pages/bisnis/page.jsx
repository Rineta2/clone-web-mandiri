...
import bg from "@/components/assest/bisnis/bg.jpg";
      ...
      <section className="relative min-h-[60vh]">
        <div className="container px-12 mx-auto">
          <div className="absolute top-4 left-[20.8%] flex items-center gap-2">
            ...
            <span className="text-background text-[16px]">Bisnis</span>
          </div>
          ...
          <div className="absolute top-[50%] translate-y-[-50%] left-[20.8%] flex flex-col gap-2">
            ...
            >
              Bisnis Anda adalah fokus utama kami
            </h1>

            <p className="text-[20px] text-background max-w-[35%]">
              Kami senantiasa mendukung pertumbuhan dan perkembangan usaha Anda
              dengan solusi dan layanan yang lengkap dan terintegrasi sesuai
              pola bisnis Anda
            </p>
          </div>
